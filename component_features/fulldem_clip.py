...
arcpy.Buffer_analysis(input_points, "F:\\independent_study\\visibility_analysis\\output_files\\va_rALL_buf.shp", buffersize)

# Clips full DEM to extent of buffer output_file
arcpy.Clip_management(full_dem, "#", "F:\\independent_study\\visibility_analysis\\dem_files\\clipped_dem.tif", "F:\\independent_study\\visibility_analysis\\output_files\\va_rALL_buf.shp", "#", "ClippingGeometry")
