...
for recordnumber in range(0,1):
	...
	arcpy.Clip_management(subset_dem, "#", "F:\\independent_study\\visibility_analysis\\bboard_clip\\bb_r%rclip" % recordnumber, "F:\\independent_study\\visibility_analysis\\bboard_buffer\\bb_r%rbuf.shp" % recordnumber, "#", "ClippingGeometry")
